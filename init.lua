...
-- Don't auto add comments in newline
...
-- Use terminal colors for bufferline
...
end, { desc = 'Close buffer without affecting layout' })

-- Reorder bufferline buffers
...
require('lazy').setup({
  ...
  -- Fix layout after closing buffer
